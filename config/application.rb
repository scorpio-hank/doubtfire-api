...
module Doubtfire
  ...
  class Application < Rails::Application
    ...
    config.eager_load_paths << Rails.root.join('app') << Rails.root.join('app', 'models', 'comments') << Rails.root.join('app', 'models', 'feedback') << Rails.root.join('app', 'models', 'intervention')
